...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.DiscardHand(tp,s.cfilter,0,1,REASON_COST+REASON_DISCARD)
end
...
function s.cost3(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.cfilter3,tp,LOCATION_DECK,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,s.cfilter3,tp,LOCATION_DECK,0,1,1,nil)
