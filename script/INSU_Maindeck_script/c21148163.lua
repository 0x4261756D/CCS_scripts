...
function c21148163.initial_effect(c)
	--link summon
	c:EnableReviveLimit()
	aux.AddLinkProcedure(c,nil,4,4,c21148163.lcheck)
	--add
...
function c21148163.splimit(e,se,sp,st)
	...
	return c:IsLocation(LOCATION_EXTRA) --and 0,~Duel.GetLinkedZone(c:GetControler())&0x1f 
end
...
function c21148163.seqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.CheckLocation(tp,LOCATION_MZONE,seq+a) then
		...
		Debug.Message(Duel.IsExistingMatchingCard(c21148163.rmfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil,tp,e,a))
