...
function s.thfilter(c)
	return c:IsSetCard(0x60) and c:IsType(TYPE_SPELL) and c:IsAbleToHand() and not c:IsCode(id)
end
...
function s.imtg(e,c)
	return c:IsSetCard(0x60) and c:IsType(TYPE_SPELL) and not c:IsCode(id)
end
