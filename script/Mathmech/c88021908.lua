...
function s.synfilter(c,mat,e,tp)
	return c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_SYNCHRO,tp,false,false) and c:IsSynchroSummonable(mat,mat)
end
function s.syncost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SendtoGrave(mat,REASON_COST+REASON_MATERIAL+REASON_SYNCHRO)
end
