...
function s.thcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:IsReason(REASON_EFFECT) and not c:IsLocation(LOCATION_DECK) --and Duel.IsExistingMatchingCard(s.lfilter,tp,LOCATION_EXTRA,0,1,nil)
end
