...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		c:RegisterFlagEffect(id,RESET_EVENT+0x17a0000+RESET_PHASE+PHASE_END,0,1)
...
function s.vo(e,tp)
	...
	if ec:GetFlagEffect(id)==0 then e:Reset() return end
	Duel.RaiseSingleEvent(ec,id,nil,nil,nil,nil,nil)
	e:Reset()
end
